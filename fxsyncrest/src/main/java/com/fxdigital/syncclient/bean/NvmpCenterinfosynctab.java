...
/**
 * NvmpCenterinfosynctab entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "nvmp_centerinfosynctab", catalog = "nvmp")
public class NvmpCenterinfosynctab implements java.io.Serializable {
	...
	/** default constructor */
	public NvmpCenterinfosynctab() {
	}

	/** minimal constructor */
	public NvmpCenterinfosynctab(String centerId, String centerName) {
