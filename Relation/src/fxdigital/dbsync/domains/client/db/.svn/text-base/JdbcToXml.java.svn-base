...
//					//logger.info(" columnNames[j]" + columnNames[j]+" columnNames[k]"+columnNames[k]);
...
//	}
	...
	public static void main(String[] args) throws SQLException {
		...
		// String xml = "sync00D0C900002C@001.xml";
		...
		JdbcToXml jdbc = new JdbcToXml();
		String path = "c:\\00D0C900002C@001.xml";

		String xml = jdbc.writeTheXml("000BAB65C2ED@001");


//		logger.info("-------------xml-------------");
//		logger.info(xml);

		List<String> sqls = jdbc.xmlToInsert(xml, "000BAB65C2ED@001");
		StringBuffer sb = new StringBuffer();
		for (int i = 0; i < sqls.size(); i++) {
			String str = sqls.get(i) + ";".toString();
			if (System.getProperty("os.name").equals("Linux")) // 操作系统名称
