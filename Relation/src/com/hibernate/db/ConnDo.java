...
public class ConnDo {
    ...
    public List<DeviceModel> getDeviceModel(String aim){
    	List<DeviceModel> list=new ArrayList<DeviceModel>();
  		...
  		try {
  			...
  			while (resultSet.next()) {
				...
				dev.setDeviceId(resultSet.getString(1));
				...
				dev.setDevName(resultSet.getString(3).trim());
				dev.setDevIP(resultSet.getString(4).trim());
