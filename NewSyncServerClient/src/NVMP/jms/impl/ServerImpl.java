...
/*    */ 
/*    */   public ServerImpl(String userid)
/*    */     throws JMSException
/*    */   {
/* 21 */     this.recive_QueueConsole = new QueueConsole(userid, "clientQueue");
/* 22 */     this.sned_QueueConsole = new QueueConsole(userid, "serverQueue");
/*    */   }
/*    */ 
/*    */   public void AddListener(IMessageHander im) {
/* 26 */     this.recive_QueueConsole.addNoFilterListener(im);
/*    */   }
/*    */ 
/*    */   public void QueueSend(String userid, Message mg, byte[] data) throws JMSException
/*    */   {
/* 31 */     this.sned_QueueConsole.SendMessage(userid, mg, data);
/*    */   }
/*    */ 
 ...
 * Qualified Name:     NVMP.jms.impl.ServerImpl
