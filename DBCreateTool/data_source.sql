...
--
-- Host: localhost    Database: jms_server
-- ------------------------------------------------------
...
CREATE TABLE `data_source` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5274 DEFAULT CHARSET=gbk;
...
INSERT INTO `data_source` VALUES (5271,'gfds','gfdsg',NULL,NULL,NULL,NULL,NULL),(5272,'fd','gfds',NULL,NULL,NULL,NULL,NULL),(5273,'fdsf','sdfd',NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2015-04-01 14:04:03
