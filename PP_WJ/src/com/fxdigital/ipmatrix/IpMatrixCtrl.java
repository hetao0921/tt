...
//			System.load("/usr/local/center/IpMatrix/so/libUsageEnvironment.so");
	...
	public static void main(String...args) {
		...
		IpMatrixCtrl ic =	IpMatrixCtrl.getIpMatrixCtrl("HIKHD6408");

		int n = ic.MaxtrixCreate(100, 1, "192.168.1.195", 8000, "admin", "12345");
		System.out.println("  n=  "  + n);
		ic.MaxtrixStart(n, 0, 0, "192.168.1.197", 8000,"admin", "12345", 1, 100, 0, 0);
