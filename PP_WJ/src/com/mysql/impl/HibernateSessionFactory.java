...
public class HibernateSessionFactory {
	...
	static {
    	try {
//			configuration.configure("com/mysql/impl/hibernate.cfg.xml");
    		
    		
    		String path=System.getProperty("user.dir")+File.separator+"conf"+File.separator+"hibernate.cfg.xml";
...
//			configuration.configure(path);
    ...
    private static Properties getExtraProperties(){
    	...
    	String url = "jdbc:"+ReadDBConfig.DBType+"://"
    					+ReadDBConfig.IP+":"+ReadDBConfig.Port+"/nvmp";
