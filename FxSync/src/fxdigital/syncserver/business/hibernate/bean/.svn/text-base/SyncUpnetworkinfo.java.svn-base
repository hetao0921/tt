...
public class SyncUpnetworkinfo implements java.io.Serializable ,IArrayPoJo{
	...
	public String[] toStringArray() {
		...
		result[1] = subId.toString();
		result[2] = subIp.toString();
		result[2] = subPort.toString();
		result[2] = supIp.toString();
		result[2] = supPort.toString();
		return result;
	}
