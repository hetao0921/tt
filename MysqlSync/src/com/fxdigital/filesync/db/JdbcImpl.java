...
//	}
	 ...
	 * @return
	 */
	public boolean updateSqls(List<String> l) {
		DBConn db = DBConn.getDBConn();
	...
	public List<String[]> getSyncFile() {
		DBConn db = DBConn.getDBConn();
	...
	public static void main(String[] args) {
		List<String[]> list=JdbcImpl.getJdbcImpl().getSyncFile();
		for(int i=0;i<list.size();i++){
			String modifiedtime=list.get(i)[1];
			String filepath=list.get(i)[2];
			String filename=list.get(i)[3];
			String file=list.get(i)[4];
			
			System.out.println(list.get(i)+"   "+modifiedtime+"  "+file);
		}
	}
