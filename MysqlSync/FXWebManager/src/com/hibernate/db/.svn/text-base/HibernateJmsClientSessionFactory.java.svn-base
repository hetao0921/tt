 ...
 */
public class HibernateJmsClientSessionFactory {
	...
	static {
    	try {
    		String path=HibernateJmsClientSessionFactory.class.getResource("").getPath();
    ...
    private HibernateJmsClientSessionFactory() {
    }
    
    //从其他配置文件获得数据库参数
    private static Properties getExtraProperties(){
    	String url = "jdbc:"+ReadDBConfig.DBType+"://"
    					+ReadDBConfig.IP+":"+ReadDBConfig.Port+"/jms_client";
	...
	public static void main(String[] args) {
		HibernateJmsClientSessionFactory h=new HibernateJmsClientSessionFactory();
