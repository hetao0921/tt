...
public class DataSelfSourceDao {
	...
	public List<String[]> getAllSelfSource() {
		...
		return db.executeQuery("from DataSelfSource");
	}
	...
	public List<HashMap<String, String>> getAllSelfSourceRecord()
			throws Exception {
		DBConn db = DBConn.getDBConn();
		String sql = "select new Map(uuid as uuid,uuname as uuname,version as version,startdate as startdate,enddate as enddate,flag as flag) from DataSelfSource order by id asc";
