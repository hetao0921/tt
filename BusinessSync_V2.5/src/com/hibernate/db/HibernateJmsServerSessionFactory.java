 ...
 */
public class HibernateJmsServerSessionFactory {
	...
	static {
    	try {
    		String path=HibernateJmsServerSessionFactory.class.getResource("").getPath();
    ...
    private HibernateJmsServerSessionFactory() {
    }
	...
	public static void main(String[] args) {
		HibernateJmsServerSessionFactory h=new HibernateJmsServerSessionFactory();
